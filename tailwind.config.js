...
const customPalettes = {
    highlight: generatePalette('#FBA301'),
    // highlight: generatePalette('#FDC300'),
    ...
    // light: generatePalette('#E6ECF3'),
    light: generatePalette('#F8F8F8'),
    lightest: generatePalette('#FFFFFF'),
};
